...
The application, service, and ingress can be deployed with `kubectl apply -f manifests`. For todos to be rendered and added, the backend must also be deployed.
